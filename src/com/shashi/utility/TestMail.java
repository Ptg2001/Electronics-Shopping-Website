...
public class TestMail {
	public static void main(String[] args) {
		try {
			String recipient = "piyush.hole2001@gmail.com";
			...
			String htmlTextMessage = "" + "<html>"
					...
					+ "<h2 style='color:red;'>Welcome to E-Gadget Galaxy</h2>" + "<p>Hey,<br>"
					+ "Thanks for singing up with E-Gadget Galaxy.<br>"
					...
					+ "<span class='greenText'>EGADGET500</span><br><br>" + "Have a good day!<br>" + "</p>" + "</body>"
					+ "</html>";
